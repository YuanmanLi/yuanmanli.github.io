const data = {
    ...
    profile: {
        ...
        <p>His research interests include multimedia information security and computer vision. He was selected as a Level C talent of Shenzhen's "Peacock Plan" for Overseas High-Caliber Personnel. He has presided over multiple National Natural Science Foundation projects, provincial and ministerial natural science foundation projects, and corporate horizontal projects. He has published over 60 papers in authoritative international journals and conferences such as T-IP, T-IFS, T-SC, T-CSVT, T-MM, T-NNLS, CVPR, ACM MM, and AAAI. His research results won the 2022 Macau Natural Science Award. He serves as an Associate Editor for the IEEE Signal Processing Letters (SPL), and as a reviewer for multiple journals including IEEE Transactions on Image Processing and IEEE Transactions on Information Forensics and Security.</p>`
    },
...
Qiangqiang Shen, Xuanqi Zhang, Shuqin Wang, Yuanman Li, Yongsheng Liang, Yongyong Chen, "Dual Completion Learning for Incomplete Multi-View Clustering" IEEE Transactions on Emerging Topics in Computational Intelligence (TETCI) , vol. 9, no. 1: pp: 455-467, 2025.
Yijun Chen, Xianwei Zheng, Zhulun Yang, Xutao Li, Jiantao Zhou, Yuanman Li, "DuPMAM: An Efficient Dual Perception Framework Equipped With a Sharp Testing Strategy for Point Cloud Analysis," IEEE Transactions on Multimedia (T-MM), pp.1760-1771, 2025.
Jie Du, Chuyang Chen, Yuanman Li, Yaolin Zhu, Peng Liu, Tianfu Wang, "SMOD: An Accurate and Efficient Segmentation-Based Medical Object Detector," IEEE Transactions on Emerging Topics in Computational Intelligence (TETCI), vol. 8, no. 6, pp: 4106-4118,  2024.
